...
def sa(objective, area, iterations, step_size, temperature):
    ...
    for i in range(iterations):
        ...
        # Accept new point if better or probabilistically
        ...
        if mia_step_eval < start_point_eval:
            ...
            print('Acceptance Criteria = %.5f' % mac, "Iteration =", i, 
                  "Best so far =", start_point, "New best =", start_point_eval)
...
best_point, best_eval, outputs = sa(objective, area, iterations, step_size, temperature)

# Plot the improvement
pyplot.plot(outputs, 'ro-')
pyplot.xlabel('Improvement Steps')
